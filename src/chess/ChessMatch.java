...
public class ChessMatch {
    ...
    /**
     * Special move to promoted
     * @param type
     * @return new piece promoted
     */
    ...
    /**
     * This method is useful for types of verification to be promoted
     * @param type
     * @param color
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece) {
        ...
        //Special undomove castiling kingside rook
        if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
        	Position sourceT = new Position(source.getRow(), source.getColumn() + 3);
        	Position targetT = new Position(source.getRow(), source.getColumn() + 1);
        ...
        //Special undomove castling queenside rook
        if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
        	Position sourceT = new Position(source.getRow(), source.getColumn() - 4);
        	Position targetT = new Position(source.getRow(), source.getColumn() - 1);
        	ChessPiece rook = (ChessPiece)board.removePiece(targetT);
    ...
    private boolean testCheckMate(Color color) {
        ...
        List<Piece> list = piecesOnTheBoard.stream().filter(x -> ((ChessPiece) x).getColor() == oponnent(color)).collect(Collectors.toList());
